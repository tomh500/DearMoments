...
android-project/app/src/CS2/main/DM/java/org/libsdl/app/SDLActivity.java
...
Here's an explanation of the files in the Android project, so you can customize them:
    ...
    android-project/app
        ...
        src/CS2/main/DM/AndroidManifest.xml	- package manifest. Among others, it contains the class name of the main Activity and the package name of the application.
        ...
        src/CS2/main/DM/assets/	- directory holding asset files for your application
        src/CS2/main/DM/res/		- directory holding resources for your application
        src/CS2/main/DM/res/mipmap-*	- directories holding icons for different phone hardware
        src/CS2/main/DM/res/values/strings.xml	- strings used in your application, including the application name
        src/CS2/main/DM/java/org/libsdl/app/SDLActivity.java - the Java class handling the initialization and binding to SDL. Be very careful changing this, as the SDL library relies on this implementation. You should instead subclass this for your application.
...
Any files you put in the "app/src/CS2/main/DM/assets" directory of your project
